...
public class FileIO{
	...
	public static String read(String fullFilePath,Parser parser ) {
		return read( fullFilePath, "UTF-8",parser);
	}
	public static String read(String fullFilePath,String charCode,Parser parser ) {
		String line = null;		
		StringBuffer strBuf = new StringBuffer();		
		BufferedReader bufReader = null;
		try {
